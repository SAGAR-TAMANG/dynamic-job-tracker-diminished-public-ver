...
timesjobs = pd.read_excel(os.path.join(current_directory, 'data_fetcher', 'scripts', 'data', "TimesJobs_" + str(datetime.date.today()) + ".xlsx"))
...
print("THIS IS TIMESJOBS AFTER THE CLEANING:\n ", dt['City'])
print("**********************************************")
...
dt.to_excel(os.path.join(current_directory, 'data_visualization', 'exported_data', "TimesJobs_" + str(datetime.date.today()) + ".xlsx"))
...
# df = pd.read_excel(os.path.join(current_directory, 'data_visualization', 'exported_data', "TimesJobs_" + str(datetime.date.today()) + ".xlsx"))
...
fig = px.choropleth_mapbox(
    ...
    hover_name="State",
    hover_data=["count"],
    title="Number of Jobs - TimesJobs",
...
fig.write_html(os.path.join(current_directory, 'templates', 'IndianMap', 'map_of_india_TimesJobs_' +  str(datetime.date.today())+ '.html'), full_html=False, config=config)
# fig.show()