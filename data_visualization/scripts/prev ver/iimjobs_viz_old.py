...
naukri = pd.read_excel(os.path.join(current_directory, 'data_fetcher', 'scripts', 'data', "IIMJobsJobListing_" + str(datetime.date.today()) + ".xlsx"))
...
dt.to_excel(os.path.join(current_directory, 'data_visualization', 'exported_data', "IIMJobsJobListing_" + str(datetime.date.today()) + ".xlsx"))
...
for feature in india_states["features"]:
    ...
    print('TEST :', feature["properties"]["st_nm"].title())
...
df = pd.read_excel(os.path.join(current_directory, 'data_visualization', 'exported_data', "IIMJobsJobListing_" + str(datetime.date.today()) + ".xlsx"))
...
fig = px.choropleth_mapbox(
    ...
    hover_name="State",
    hover_data=["count"],
    title="Map of India showing the job listings - IIMJobs",
...
fig.write_html(os.path.join(current_directory, 'templates', 'IndianMap', 'map_of_india_IIMJobListing_' +  str(datetime.date.today())+ '.html'), full_html=False, config=config)
fig.show()
